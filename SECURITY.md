...
SplitProof does not execute dataset content, but it parses untrusted JSON and writes output
files. Do not use it as a sandbox boundary.
...
impact, and any suggested mitigation. Maintainers will acknowledge a complete report within
